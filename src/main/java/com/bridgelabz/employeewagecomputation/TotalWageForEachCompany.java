...
public class TotalWageForEachCompany {
    ...
    TotalWageForEachCompany(String companyName, int empWagePerHour, int maxWorkingDays, int maxWorkingHrs) {
    ...
    public static void main(String[] args) {
        ...
        TotalWageForEachCompany company1 = new TotalWageForEachCompany("DXC", 100, 24, 200);
        TotalWageForEachCompany company2 = new TotalWageForEachCompany("HCL", 180, 26, 200);
