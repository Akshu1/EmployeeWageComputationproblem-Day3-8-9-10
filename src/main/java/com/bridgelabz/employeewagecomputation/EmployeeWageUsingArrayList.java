...
import java.util.Random;
    public class EmployeeWageUsingArrayList implements InterfaceEmployeeWage {
        int noOfCompanies, index;

        ArrayList<CompanyEmpWage> companies; //ArrayList declaration

        // Constructor for EmployeeWage  class
        ...
        public static void main(String[] args) {
            ...
            EmployeeWageUsingArrayList emp = new EmployeeWageUsingArrayList(); //creating an object and declaring number of companies = 3
            emp.addCompany("Bridgeabz", 20, 20, 100);
            emp.addCompany("HCL", 34, 23, 130);
            emp.addCompany("DXC", 10, 15, 99);
            emp.companyWage();
        }
